 ...
 *  title       = @Translation("Move @operand"),
 *  menu        = @Translation("Move @operand..."),
  ...
  public function execute() {
    ...
    if ($nItems === 1) {
      ...
      $this->addExecuteMessage(t(
        ($destinationQuoted === TRUE ?
          'The @kind "@name" has been moved to "@destination".' :
          'The @kind "@name" has been moved to @destination.'),
        [
    ...
    elseif (count($selection) === 1) {
      ...
      $this->addExecuteMessage(t(
        ($destinationQuoted === TRUE ?
          '@number @kinds have been moved to "@destination".' :
          '@number @kinds have been moved to @destination.'),
        [
          '@number'      => $nItems,
      ...
      $this->addExecuteMessage(t(
        ($destinationQuoted === TRUE ?
          '@number items have been moved to "@destination".' :
          '@number items have been moved to @destination.'),
        [
          '@number'      => $nItems,
          '@destination' => $destinationName,
